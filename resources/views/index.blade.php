    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                ...
                <p class="parrafo_seccion2">Thank you for stopping by! I’m Ximena the mother, baker, designer, horse and dog lover and so much more. I’m an Interior Designer with a hobby that started with cake pops for my daughters parties and one day BOOM it blossomed into a full-blown business that keeps me really busy. From creating cakes and sweets to decorating kids parties and everything in between. Everything I do is just a stress release and I love the happy little faces when they see their cakes and decor for their special day. When I’m not in the kitchen you will find me spending endless hours watching my daughter ice skate or with my family on a cruise or vacationing somewhere exciting.</p>
            </div>
        </div>
    </div>
</section>
...
<section id="seccion3">
    ...
    <p class="parrafo-seccion3">Being an Interior Designer gives me the ability to apply color theory, balance and design to everything I create and keeping all this within budget.</p>
</section>
<!-- End Seccion 3 -->
<!-- Seccion 4 -->
<section id="seccion4">
